...
def main():
    ...
    # model args
    parser.add_argument("--model_name", default='CL4Rec', type=str)
    parser.add_argument('--aug_type', default='reorder', type=str)
    ...
    parser.add_argument("--reorder_ratio", type=float, default=0.3, help="reorder ratio")
    ...
    # save model args
    args_str = f'{args.model_name}-{args.data_name}-{args.aug_type}'
    ...
    for epoch in range(args.pre_epochs):
        ...
        args.mask_ratio = (epoch//5+1)*0.015
        args.crop_ratio = (epoch//5+1)*0.015
        args.reorder_ratio = (epoch//5+1)*0.015
        ...
        if (epoch+1) % 10 == 0:
            ckp = f'CL4Rec-{args.data_name}-{args.aug_type}-epochs-{epoch+1}.pt'
